...
summary: ''
authors: []
lastmod: '2019-10-01T22:56:23+08:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
In this post I look at the family of collexeme analysis methods originated by Gries and Stefanowitsch. 
...
They are also known as tests of cue validity and are caluclated as follows:
...
```{r, echo=FALSE, message=FALSE}
df.must <- read_csv(here::here("static", "files", "must.results.csv")) %>%
