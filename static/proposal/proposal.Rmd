...
1. How have these structures evolved over time?
...
Chinese has a folk model of *xíng yīn yì* 形音義: .sc[written form], .sc[phonological form] and .sc[meaning]  
(all culminating in 'the character' *zì* 字, cf. .ref[Packard 1998; 2000])
...
.Large[.markeer2[How have these structures evolved over time?]]
...
![:scale 140%](huihui-fire.png)
![:scale 140%](huihui-light.png)
![:scale 140%](huihui-sun.png)
...
I categorized the most frequent collocates of the mental spaces into frames and domains.
...
The preceding diagram leads to two further questions, in relation to the case study:
<!-- Taht I haven't talked about in my proposal -->

1. If we collapse the variable `time`, what are the frames that co-occur with the three *huīhuī*s?
1. Given that there are three different radicals (部首/偏旁/functional components), how much do certain radicals *attract* certain frames?
...
.Large[.markeer2[RQ2: How have these structures evolved over time?]]
