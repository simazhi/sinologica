...
date: "<br>Proposal<br>28 January 2019<br>National Taiwan University"
output:
...
.sc[inner feelings and cognitive states] | *tántè* 忐忑 'be perturbed, mentally disturbed'
...
--- | --- | ---
擬聲詞 <br> *giongo* 擬音語 <br> .markeer[phonomimes] | .markeer2[ideophones] <br>  onomatopoeia | non-red. or A| 哔 'beep', <br> 咻 'shew' (.sc[sound + visual])
...
* **formal component**: marked words
* **meaning component**: depiction of sensory imagery
...
.sc[writing] vs. .sc[sound]  | <丁丁\> as /dīngdīng/ or /zhēngzhēng/
.sc[meaning] vs. .sc[sound] <br> .font80[.ref[(onomasiology)]] | .sc[brightness] expressed with different ideophones (see case study)
.sc[writing] vs. .sc[sound] <br> .font80[.ref[(onomasiology)]] |.sc[brightness] expressed with different ideophones (see case study)
...
1. a list of particles used in Premodern Chinese .ref[(based on Jonker, Esch & Mansvelt Beck 2011)]
...
1.  find out ***that*** .markeer[variation] is important for Chinese ideophones, in the three poles (.markeer2[meaning], .markeer2[phonological form], and .markeer2[written form]) of the Chinese folk model.
...
Bybee, Joan L. & Paul J. Hopper (eds.). 2001. Frequency and the emergence of linguistic structure (Typological Studies in Language 45). Amsterdam: Benjamins.
...
Forceville, Charles & Eduardo Urios-Aparisi (eds.). 2009. Multimodal metaphor (Applications of Cognitive Linguistics 11). Berlin ; New York: Mouton de Gruyter.
...
Haiman, John. 2018. Ideophones and the evolution of language. Cambridge University Press. doi:10.1017/9781107706897 (26 November, 2018).
...
Jonker, Dirk R., Daan J.J. van Esch & Burchard J. Mansvelt Beck. 2011. Wenyan partikels. Leiden: Stichting Shilin.
...
Silge, Julia. 2017a. Word vectors with tidy data principles. [2017-30-10]. https://juliasilge.com/blog/tidy-word-vectors/ (4 November, 2018).

Silge, Julia. 2017b. Tidy word vectors, take 2! [2017-11-27]. https://juliasilge.com/blog/word-vectors-take-two/ (4 November, 2018).

Simone, Raffaele (ed.). 1995. Iconicity in language (Amsterdam Studies in the Theory and History of Linguistic Science v. 110). Amsterdam ; Philadelphia: J. Benjamins.
]
