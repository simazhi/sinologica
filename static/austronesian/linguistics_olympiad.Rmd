...
* no-Phillipine-type voice <br> (like we saw in 何老師's talk)
...
.font80[
Tagalog (Langacker 2008 adapted from Schachter 1976)
TR = trajector; TF = theme focus; LF = locative focus; beneficiary focus
]
...
Reduplication can have many meanings: repetition (*hahanup*), intensive (人海茫茫), diminution 'make smaller' (看看)...
...
| un-huma | ‘to | farm’ | m-un<hu>huma | munhuhuma | ‘farmer’ |
...
| Yami | rala 'next to the mountain | / (?)
...
DEBOJECTIVE: completely removing the O
...
* *ma-la~laʔla* <br> AF-RED~call <br> keep on calling
...
| --- | --- | --- | ---
| alphabet | up->down, left->right | different forms beginning, middle, end | sometimes ligatures (combinations)
]
